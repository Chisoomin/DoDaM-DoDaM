...
class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String testSQL = "create table Dodam(" +
                ...
                "depressionreason text,"+ // 우울의 원인
                "point integer)"; // 도담 포인트

        db.execSQL(testSQL);
        testSQL = "insert into Dodam(name, type, pass, passHint, passHintAns, birthday, depressionreason, point) values('김명지', '여자', '1111', '1이 네 개면?', '1111', '프로젝트','2000-11-08', 0)";
        db.execSQL(testSQL);
